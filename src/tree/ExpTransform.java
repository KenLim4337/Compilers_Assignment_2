...
public interface ExpTransform<ResultType> {
    ...
    ResultType visitFieldNode(ExpNode.FieldNode node);
    ResultType visitNewPointerNode(ExpNode.NewPointerNode node);
    ResultType visitPointerDerefNode(ExpNode.PointerDerefNode node);
}