...
public abstract class ExpNode {
    ...
    public static class RecordNode extends ExpNode {
        ...
        //Map with ID, FieldNode
        private SortedMap<String,ExpNode> fields;

        //Stuff
        private Type.RecordType type;
        private List<ExpNode> list;
        
        public RecordNode(Location loc, Type type, List<ExpNode> l) {
            super(loc);
            assert type instanceof Type.RecordType;
            this.type = (RecordType) type.resolveType(loc);
            this.list = l;
            this.fields = new TreeMap<String,ExpNode>();
        }
        ...
        public void setList(List<ExpNode> l) {
            this.list = l;
        }
        
        public SortedMap<String,ExpNode> getFields() {
            return this.fields;
        }
        
        //For populating fields
        public void addField(String id, ExpNode f) {
            fields.put(id, f);
        }
        
        public ExpNode getField(String id) {
        ...
        public String toString() {
            ...
            for(Entry<String,ExpNode> x: fields.entrySet()) {
                temp += (x.getKey() + ": " + x.getValue()) + "\n";
            }
    ...
    public static class FieldNode extends ExpNode {
        ...
        public FieldNode(Location loc, ExpNode exp, String id) {
            super(loc);
            this.id = id;
            this.parent = exp;
        ...
        public void setParent(ExpNode nParent) {
            this.parent = nParent;
        }
    ...
    public static class NewPointerNode extends ExpNode {
        ...
        public NewPointerNode(Location loc, Type type) {
            //
            super(loc, type.resolveType(loc));
        }
    ...
    //pointer dereference
    public static class PointerDerefNode extends ExpNode {

        ExpNode pointerValue;
        
        public PointerDerefNode(Location loc, ExpNode lv) {
            super(loc);
            this.pointerValue = lv;
        }
        ...
        public void setValue( ExpNode leftValue ) {
            pointerValue = leftValue;
        }
        
        @Override
        public ExpNode transform(ExpTransform<ExpNode> visitor) {
            return visitor.visitPointerDerefNode ( this );
        }
